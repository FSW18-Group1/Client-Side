        ...
        <Fragment>        
            <div data-testid={'profile'} className="section">
                <Form className="container profile-form">
                    <div data-testid={'profile-picture'} className='profile-picture'>
                        <img 
                    ...
                    <Form.Group className="mb-3" controlId="formBasicEmail">
                        ...
                        <Form.Control data-testid={'profile-email'} type="email" value={getProfilePlayerEmail} placeholder='email' disabled />
                    </Form.Group>
                    <Form.Group className="mb-3" controlId="formBasicEmail">
                        <Form.Label>Username</Form.Label>
                        <Form.Control data-testid={'profile-username'} type="text" value={getProfilePlayerUsername} placeholder='username'  disabled />
                    </Form.Group>
                    <Link to='/gamepage/1'><button data-testid={'profile-link'} className="me-4 btn btn-danger">&laquo; back</button></Link>              
                </Form>
            </div>
        </Fragment>
    )
